...
from . import views
from .views import home, profile, RegisterView, EditProfileView, ResendCodeView, privacyPolicy, contact_view, \
    SettingsView, settings_view, CustomPasswordResetView, CustomPasswordResetConfirmView
